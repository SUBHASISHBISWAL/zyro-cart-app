    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-7 pb-5">
            ...
            <div class="d-flex mb-3">
                <?php
                $rating = $product['rating']; // example rating (can come from DB)

                $fullStars = floor($rating);          // full stars
                $halfStar  = ($rating - $fullStars) >= 0.5 ? 1 : 0; // half star
                $emptyStars = 5 - ($fullStars + $halfStar); // remaining
                ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="media mb-4">
                                <img src="<?php echo $base; ?>assets/img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
    ...
    $(document).ready(function() {
        ...
        function loadShopProducts() {
            let product_id = <?php
                                ...
                                ?>;
            $.ajax({
                url: '../api/products/product_detail.php',
                type: 'GET',
                data: {
