    ...
    <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-dark mb-2" href="pages/detail.php"><i class="fa fa-angle-right mr-2"></i>Shop Detail</a>
                            <a class="text-dark mb-2" href="pages/cart.php"><i class="fa fa-angle-right mr-2"></i>Shopping Cart</a>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            ...
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="img-fluid" src="<?php echo $base; ?>assets/img/payments.png" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
