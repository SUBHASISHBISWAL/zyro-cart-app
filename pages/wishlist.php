...
<div class="container-fluid bg-secondary mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 200px">
        <h1 class="font-weight-semi-bold text-uppercase mb-3" style="letter-spacing: 2px;">My Wishlist</h1>
        <div class="d-inline-flex">
            ...
            <p class="m-0 px-2 text-muted">-</p>
            <p class="m-0 text-muted">Wishlist</p>
        </div>
    </div>
</div>
        ...
        <div class="col-lg-3 col-md-4 mb-5">
            <div class="card premium-card h-100">
                ...
                <div class="list-group list-group-flush px-3 pb-4 border-0">
                    ...
                    <a href="wishlist.php" class="list-group-item list-group-item-action sidebar-link active border-0 py-3">
        ...
        <div class="col-lg-9 col-md-8">
            <div class="card premium-card mb-4" style="min-height: 100%;">
                <div class="card-header bg-white border-0 p-5 pb-3">
                    <h3 class="font-weight-bold m-0 text-dark">My Favorites</h3>
                    <p class="text-muted">Manage the items you've saved for later.</p>
                </div>
                <div class="card-body p-5 d-flex flex-column align-items-center justify-content-center text-center">
                    <div class="mb-4">
                        <div class="rounded-circle d-inline-flex align-items-center justify-content-center" style="width: 100px; height: 100px; background: rgba(209, 156, 151, 0.1);">
                            <i class="fas fa-heart fa-3x" style="color: #D19C97;"></i>
                        </div>
                    </div>
                    <h4 class="font-weight-bold text-dark mb-3">Your Wishlist is Empty</h4>
                    <p class="text-muted mb-4" style="max-width: 400px;">Looks like you haven't saved anything yet. Save items you love and buy them later.</p>
                    <a href="shop.php" class="btn btn-primary btn-premium">Explore Shop</a>
                </div>
            </div>
        </div>
        </div>
