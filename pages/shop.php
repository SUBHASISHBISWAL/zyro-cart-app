...
<div class="container-fluid pt-5">
    ...
    <form>
        ...
        $colors_query = "SELECT color_name FROM `colors` ORDER by color_name ASC";
            ...
            while ($row = $colors_result->fetch_assoc()) { ?>
                <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                    <input type="checkbox" class="custom-control-input filter-color" 
                           data-color="<?php echo $row['color_name']; ?>" 
                           value="<?php echo $row['color_name']; ?>" 
                           id="color-<?php echo $row['color_name']; ?>">
                    <label class="custom-control-label" for="color-<?php echo $row['color_name']; ?>">
